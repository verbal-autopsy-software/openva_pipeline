    ...
    def smartVA_to_csv(self):
        ...
        dfRecordStorage = merge(left=dfResults[colsKeep],
                                ...
                                right_on=["Generalmodule-sid",
                                          "general5-name-gen_5_0",
                                          "general5-name-gen_5_0a"],
                                how="right")
        dfRecordStorage.rename(columns =
                               {"meta-instanceID": "odkMetaInstanceID"},
                               inplace = True
        )
        dfRecordStorage.drop(columns=["sid", "name", "surname"], inplace = True)
        ...
        colsKeep = ["sid", "cause34", "metadataCode", "name", "surname"]
        ...
        dfTemp.drop(columns=["sid", "name", "surname"], inplace=True)
